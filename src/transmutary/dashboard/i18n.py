...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "settings_llm_preset": "Provider preset",
        "settings_llm_api_key": "API Key",
        "settings_llm_base_url": "Base URL",
        "settings_llm_provider_custom": "— choose provider —",
        "settings_llm_preset_choose": "— choose provider —",
        ...
        "settings_llm_env_locked": "Locked by env var",
    ...
    "zh": {
        ...
        "settings_llm_preset": "Provider 预设",
        "settings_llm_api_key": "API Key",
        "settings_llm_base_url": "Base URL",
        "settings_llm_provider_custom": "— 选择 provider —",
        "settings_llm_preset_choose": "— 选择 provider —",
        ...
        "settings_llm_env_locked": "由环境变量锁定",
